            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {courses.map((course) => (
                  <span
                    key={course}
                    className="inline-flex items-center rounded-lg border border-border/50 bg-secondary/50 px-3 py-1.5 text-sm text-foreground transition-all duration-200 hover:border-[#1e40af]/30 hover:bg-[#1e40af]/6 hover:shadow-[0_0_12px_rgba(30,64,175,0.08)]"
                  >
                    {course}
                  </span>
                ))}
          ...
          <div className="relative">
            ...
            <div className="flex flex-col gap-8">
              {projects.map((project, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-[11px] top-2 h-2.5 w-2.5 rounded-full border-2 border-[#1e40af]/50 bg-background ring-4 ring-background sm:left-[15px]" />
